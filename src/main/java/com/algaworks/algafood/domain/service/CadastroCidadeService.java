...
public class CadastroCidadeService {
	...
	private static final String MSG_ESTADO_NAO_ECONTRADO = "Não existe cadastro de estado com código %d";
	...
	public Cidade salvar(Cidade cidade) {
		...
		if (estado.isEmpty()) {
			throw new EntidadeNaoEncontradaException(String.format(MSG_ESTADO_NAO_ECONTRADO, estadoId));
		}
